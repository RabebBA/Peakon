...
export function ProjectRoleTable() {
  ...
  useEffect(() => {
    async function fetchAll() {
      const [rolesRes, privsRes, routesRes] = await Promise.all([
        privateFetch.get("/role/project"),
        privateFetch.get("/privileges/project"),
  ...
  // Filter, search, status, pagination
      ...
      <section className="h-screen rounded-xl border  shadow-md p-6 mb-2">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-bold ">Project Roles</h3>
          </div>
          <DialogCreateRole
            open={addOpen}
            ...
            initialData={{ type: "Project" }} // Forcer le type
            trigger={
        ...
        {/* Barre de recherche + filtre status */}
